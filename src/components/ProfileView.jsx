...
import {
  ...
  Smartphone, Target, Wallet, Edit3, X
} from 'lucide-react';
...
export default function ProfileView({ role, dashboardData, onLogout, onProfileUpdate }) {
  ...
  return (
    <div className="space-y-6 mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
      {/* Header */}
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white">Profil & Pengaturan</h2>
        <p className="text-sm text-slate-500">Kelola akun dan preferensi aplikasi</p>
      </section>
      ...
      {error && (
        <div className="bg-red-50 dark:bg-red-950/30 border border-red-100 dark:border-red-900/50 text-red-700 dark:text-red-400 px-4 py-3 rounded-xl flex items-center gap-2 text-sm font-medium">
          ...
          {error}
          <button onClick={() => setError('')} className="ml-auto text-xs font-bold underline">Tutup</button>
        </div>
      )}
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Attainment</span>
            </div>
          ...
          <Card className="p-4">
            ...
            <p className="text-xs text-slate-500 mt-0.5">Total bonus bulan ini</p>
          </Card>
        </div>
      )}
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Team Attainment</span>
            </div>
          ...
          <Card className="p-4">
            ...
            <p className="text-xs text-slate-500 mt-0.5">Outlet tanpa salesman</p>
          </Card>
        </div>
      )}
      ...
      {/* Settings */}
      <section>
        <h3 className="font-bold text-slate-900 dark:text-white mb-3 px-1">Pengaturan</h3>
        <Card className="p-0 overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-slate-900 dark:text-white">Tampilan</p>
                <p className="text-xs text-slate-500">{darkMode ? 'Mode Gelap' : 'Mode Terang'}</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-slate-900 dark:text-white">Ganti Password</p>
                <p className="text-xs text-slate-500">Perbarui kata sandi akun</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-slate-900 dark:text-white">Versi Aplikasi</p>
                <p className="text-xs text-slate-500">v1.0.0 • PWA Enabled</p>
              </div>
            </div>
          </div>
        </Card>
        ...
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl p-6 animate-in slide-in-from-bottom-8 duration-300 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">Edit Nama</h3>
            ...
            <form onSubmit={handleUpdateName} className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1 ml-1">Nama Lengkap</label>
                <input
                  type="text"
                  required
                  value={editName}
        ...
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:items-center">
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl p-6 animate-in slide-in-from-bottom-8 duration-300 shadow-2xl">
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1 ml-1">Password Saat Ini</label>
              ...
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1 ml-1">Password Baru</label>
                <div className="relative">
                  <input
              ...
              <div>
                <label className="block text-xs font-medium text-slate-500 mb-1 ml-1">Konfirmasi Password Baru</label>
                <div className="relative">
                  <input
